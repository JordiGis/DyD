// src/stores/useDMAttackStore.js
import { defineStore } from 'pinia'
import { v4 as uuidv4 } from 'uuid';

export const useDMAttackStore = defineStore('dm-attack', {
  state: () => ({
    attacks: [],
    criticalHit: {
  ...
  actions: {
    ...
    loadAttacks() {
      ...
      const data = localStorage.getItem('dnd-dm-attacks-data');
      if (data) {
        try {
    ...
    saveAttacks() {
      localStorage.setItem('dnd-dm-attacks-data', JSON.stringify(this.attacks));
    },
